...
function backspace(){
    var deleteInputkey  = document.getElementById('result').value;
    document.getElementById('result').value=deleteInputkey.substring(0,deleteInputkey.length -1);
}
